...
SECRET_KEY = '^!2z&q=oj(6u+ne==nmnmdawhta^pi^p-3!-!4lfrr@t2r%*@9'
...
_MONGODB_NAME = "django_graph_example"
_MONGODB_PORT = 27017
_MONGODB_DATABASE_HOST = f"mongodb://{_MONGODB_USER}:{_MONGODB_PASSWORD}@{_MONGODB_HOST}/{_MONGODB_NAME}"
